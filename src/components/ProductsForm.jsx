    ...
    <div>
      <form action="">
        <Flex vertical gap='middle'>
            ...
            <div>
                <Input placeholder='Enter Sub Title' name='subtitle' value={prodForm.subtitle} onChange={handleChange} />
            </div>
            <div>
                <Input placeholder='Enter Image Address' name='image' value={prodForm.image} onChange={handleChange} />
            </div>
            <div>
                <Input placeholder='Enter Description' name='description' value={prodForm.description} onChange={handleChange} />
            </div>
            <div>
                <Input placeholder='Enter Rate' type='number' name='rate' value={prodForm.rate} onChange={handleChange} />
            </div>
            <div>
                <Input placeholder='Enter Price' type='number' name='price' value={prodForm.price} onChange={handleChange} />
            </div>
            <div>
